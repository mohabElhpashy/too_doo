          ...
          {pricingData.map((elm, i) => {
            return (
              <Col
                ...
                md={24 / colCount}
                lg={24 / colCount}
                className={colCount === i + 1 || isMobile ? "" : "border-right"}
              >
                <div className="p-3">
        ...
        <Row gutter={60} className="mt-5">
          <Col sm={24} md={12} lg={12}>
            <div className="mb-5">
              ...
              <p>
                Twitch tail in permanent irritation poop on grasses, drink water
                out of the faucet, plays league of legends have my breakfast
                spaghetti yarn. Taco cat backwards spells taco cat stick butt in
                face.
              </p>
            </div>
            <div className="mb-5">
              ...
              <p>
                Splice the main brace Jolly Roger me hogshead prow red ensign ye
                swing the lead log ho. Handsomely spanker dance the hempen jig
                pinnace overhaul crimp tack booty rigging lateen sail. Sea Legs
                boatswain hempen halter provost bilge rat ballast maroon
          ...
          <Col sm={24} md={12} lg={12}>
            <div className="mb-5">
              ...
              <p>
                ...
                while pushing stuff off a table or i heard this rumor where the
                humans are our owners.
              </p>
            </div>
            <div className="mb-5">
              ...
              <p>
                ...
                napping is exhausting toilet paper attack claws fluff everywhere
                meow miao french ciao litterbox.
              </p>
            </div>
          </Col>
        </Row>
