...
const Demo = () => {
  ...
  return <ColorPicker color={"#3e82f7"} colorChange={onColorChange} />;
};
  ...
  return (
    <div>
      ...
      <div className="mt-4">
        <ComponentIntro
          name="Location"
          desc="src/components/shared-components/ColorPicker.js"
        />
        <ComponentIntro
          name="Description"
          desc="ColorPicker allow you select & get the color info from color palette."
        />
      </div>
      <div className="mt-4">
        <Card title="Example">
