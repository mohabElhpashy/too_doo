...
const AddBeautyCenterServices = () => {
  ...
  const handelSubmit = async (postObject) => {
    try {
      ...
      await service.post("/web/beautyCenterServices", data);
      setLoading(false);
      setSuccess(true);
    } catch (error) {
      setLoading(false);
    ...
    <>
      {error || isSuccess ? (
        <CustomSubmittion
          ...
          samePage="beauty/AddBeautyCenterServices"
          tablePage="beauty/beautyCenterServices"
        />
      ) : (
        <>
          <h2 style={{ marginBottom: 20 }}>Adding New Beauty Center Service</h2>
          <Form
            {...formItemLayout}
            form={form}
            onSubmitCapture={(e) => {
          ...
          >
            ...
            >
              <Select
                showSearch
                placeholder="Select a Beauty Center"
            ...
            <Form.Item
              name={"main_image"}
              label="Upload a Beauty Center Service Image"
            >
              <Upload {...props}>
...
export default AddBeautyCenterServices;
