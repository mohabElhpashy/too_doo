...
const ProductForm = (props) => {
  ...
  const [postObject, setPostObject] = useState({
    ...
    service_id: serviceId.BEAUTRY_CENTER_ID,
  });
          ...
          <PageHeaderAlt className="border-bottom" overlap>
            <div className="container">
              <Flex
                ...
                alignItems="center"
              >
                <h2 className="mb-3">Edit Beauty Center Details Type</h2>
                <div className="mb-3">
                  <Button
                    className="mr-2"
                    onClick={() => history.push("beautyDetails")}
                  >
                    Go Back
                  </Button>
                  <Button
