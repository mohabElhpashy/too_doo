...
useEffect(async()=>{
  ...
  if(AllData==""){
    try {
      await service.get(`web/sellerPaymentMethods/4/${postObject.beauty_center_id}`).then(res=> setAllData(res.records));
            ...
            <div className="mt-3">
                  ...
                  <Form.Item
                    ...
                    >
                      <Select
                        ...
                        // defaultValue={postObject.beauty_center_payment_method.map((ele=>ele.paymentMethod.name_en))}
                        disabled={checkView}
                ...
                <Row   gutter={16}>
                  ...
                  <div style={{  width:"100%",  display: "flex",flexFlow:"wrap",justifyContent:"space-around"}}   >
                    ...
                    {checkView? 
                    postObject.beauty_center_payment_method.map((ele,index)=>{
    ...
    justifyContent: "end"}}>
            <Button onClick={()=>add_CHANGE(ele)}>Add</Button>
                  ...
                  PayMentmethod.map((ele,index)=>{
                    return <div style={{display:"flex"}} > 
                    <Card  key={ele.payment_method_id} disabled style={{marginBottom:"10px",width:"500px"}} title={ele.name_en} >
