...
const GeneralField = (props) => {
  ...
  const uploadHandler = async (options, name) => {
    ...
    const imageObject = { type: "Beauty_center", file: options.file };
    ...
    try {
      ...
      if (name === "main_image") {
        props.setPostObject({
          ...
          customImage: uploadResponse.file_url,
        });
      } else {
        props.setPostObject({
          ...props.postObject,
      ...
      <Col xs={24} sm={24} md={17}>
        <Card title="Basic Info">
          ...
          <Form.Item
            ...
            //       } else {
            //         return Promise.reject(
            //           "Please enter The Description ins English"
            //         );
            //       }
            //     },
            //   }),
          ...
          >
            <Select
              ...
              value={props.postObject.beauty_center_id}
      ...
      <Col xs={24} sm={24} md={7}>
        <Card title="Media">
          <Form.Item required label="Main Image">
            ...
            >
              {props.postObject.customImage ? (
                <img
                  src={props.postObject.customImage}
                  alt="avatar"
                  className="img-fluid"
                />
              ) : (
