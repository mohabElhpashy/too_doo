...
useEffect(async()=>{
  ...
  if(AllData==""){
    try {
      await service.get(`web/sellerPaymentMethods/1/${postObject.agency_id}`).then(res=> setAllData(res.records));
            ...
            <div className="mt-3">
                  ...
                  <Form.Item
                    ...
                    >
                      <Select
                        ...
                        // defaultValue={PayMentmethod.map((ele=>ele.name_en ))}
                        // defaultValue={}
                        disabled={checkView}
                ...
                <Row   gutter={16}>
                  ...
                  <div style={{  width:"100%",  display: "flex",flexFlow:"wrap",justifyContent:"space-around"}}   >
                    ...
                    {checkView? 
                    postObject.car_payment_method.map((ele,index)=>{
