...
useEffect(async()=>{
  ...
  if(AllData==""){
    try {
      await service.get(`web/sellerPaymentMethods/3/${postObject.clinic_id}`).then(res=> setAllData(res.records));
            ...
            <div className="mt-3">
                  ...
                  <Form.Item
                    ...
                    >
                      <Select
                        ...
                        // defaultValue={postObject.checkup_payment_method.map((ele=>ele.name_en))}
                        disabled={checkView}
                ...
                <Row   gutter={16}>
                  ...
                  <div style={{  width:"100%",  display: "flex",flexFlow:"wrap",justifyContent:"space-around"}}   >
                    ...
                    {checkView? 
                    postObject.checkup_payment_method.map((ele,index)=>{
