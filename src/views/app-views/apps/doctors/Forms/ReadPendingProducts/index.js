...
import CheckUpsDetails from "../EditForm/EditCheckUp/CheckUpsDetails";
...
const ProductForm = () => {
  ...
  // Store List
  const clinicRes = useFetch("clinics");
  ...
  const genericDetailes = useFetch(
    `genericDetailsProducts/${serviceId.DOCTOR_ID}`
  );
