...
import { useHistory, useLocation } from "react-router-dom";
 import GeneralField from "../Edit_Record/GeneralField";
import Loading from "components/shared-components/Loading";
import Contestants from '../Edit_Record/Contestants'
import Rewards from '../Edit_Record/Rewards'
import Competition_Products from '../Edit_Record/Competition_products'
 const { TabPane } = Tabs;
...
const ProductForm = (props) => {
  ...
  const getSingleCompetition = useFetchSingle(`competition/${recordId}`);
  const singleComp = getSingleCompetition.services;
  const isSuccess = getSingleCompetition.isSuccess;
  const refetch = getSingleCompetition.refetch;

  // const afterMount = getSingleCompetition.isFetchedAfterMount;
  ...
  useEffect(() => {
    if (isSuccess) {
      console.log("singleComp",singleComp)
      form.resetFields();
        ...
        >
          ...
          <div className="container">
            <Tabs defaultActiveKey="1" style={{ marginTop: 30 }}>
              ...
              <TabPane tab="Competition Products" key="4">
