...
import GeneralField from "../EditForms/EditDressProduct/GeneralField";
import DressDetails from "../EditForms/EditDressProduct/DressDetails";
import NewChanges from "./NewChanges";
import serviceId from "constants/ServiceIdConstants";
import DressVariationField from "../EditForms/EditDressProduct/DressVariationField";
...
const ProductForm = () => {
  ...
  const genericDetailes = useFetch(
    `genericDetailsProducts/${serviceId.DRESS_ID}`
  );
