...
const AddGenericOption = () => {
  ...
  const handelSubmit = async (postObject) => {
    try {
      if (initalState === emptyState) {
        await service.post("/web/weddingHallGenericOption", postObject);
      } else {
        await service.put(
          `/weddingHallGenericOption/${postObject.id}`,
          postObject
        );
      }
      setSuccess(true);
  ...
  return (
    <>
      {isSuccess || error ? (
        <CustomSubmittion
          samePage="hotel/AddGenericOption"
          tablePage="hotel/GenericOptions"
              ...
              {initalState === viewMode ? (
                ...
                <>
                  <Button
                    ...
                    onClick={() =>
                      history.push("/app/apps/hotel/GenericOptions")
                    }
                  >
                    Cancel
                  </Button>
