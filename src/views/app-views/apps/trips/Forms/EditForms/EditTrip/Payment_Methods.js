...
const handle_Select_Payment=(event)=>{
  ...
  // console.log("{{{{{{{{{",index)
      ...
      const add_CHANGE=(e,index)=>{
          console.log("22222222222",index)
          var values = [...PayMentmethod];
          values[index]={name_en:e.name_en,payment_method_id:e.payment_method_id
          ...
          message.success(`${e.name_en} added`)
            }
                  ...
                  <Form.Item
                    ...
                    >
                      <Select
                        ...
                        // defaultValue={postObject.makeup_payment_method.map((ele=>ele.name_en))}
                        disabled={checkView}
