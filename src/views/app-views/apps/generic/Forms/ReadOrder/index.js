...
const Invoice = () => {
  ...
  const productColumn = [
            ...
            fileList={[
              {
                ...
                name: obj.name_en,
                status: "done",
                url: obj.product_main_image,
              },
            ]}
            onPreview={(t) => setSingleImage(obj.product_main_image)}
    ...
    },
    {
      ...
      key: "variation_name",
      sorter: (a, b) => a.variation_name.length - b.variation_name.length,
      render: (_, obj) => (obj.variation_name ? obj.variation_name : "N/A"),
    },
    {
      title: "Service Type",
      ...
      {isSuccess ? (
        <div className="container">
          <Card>
            ...
            <div className="mt-4">
              <Table
                dataSource={services?.order_products}
              ...
              <div className="d-flex justify-content-end">
                ...
                <p>
                  ...
                  <h2 className="font-weight-semibold mt-3">
                    ...
                    <NumberFormat
                      displayType={"text"}
                      defaultValue={services?.total_amount}
                      value={services?.total_amount}
                      prefix={"EGP"}
                      thousandSeparator={true}
                    />
                  </h2>
