...
useEffect(async()=>{
  ...
  if(AllData==""){
    try {
      await service.get(`web/sellerPaymentMethods/5/${postObject.photographer_id}`).then(res=> setAllData(res.records));
...
return (
            ...
            <div className="mt-3">
                  ...
                  <Form.Item
                    ...
                    >
                      <Select
                        ...
                        // defaultValue={postObject.photo_session_payment_method.map((ele=>ele.name_en))}
                        disabled={checkView}
                ...
                <Row   gutter={16}>
                  ...
                  <div style={{  width:"100%",  display: "flex",flexFlow:"wrap",justifyContent:"space-around"}}   >
                    ...
                    {checkView? 
                    postObject.photo_session_payment_method.map((ele,index)=>{
    ...
    justifyContent: "end"}}>
           ...
           maxLength="3"
                        ...
                        onChange={(e) =>add_CHANGE(index,e,ele)}                           className="w-100"
                        // value={field.down_payment}
