...
const ProductForm = () => {
  ...
  const { services, isSuccess, refetch } = useFetchSingle(
    `tags/service/${ServiceIdConstants.MAKEUP_ID}/${recordId}`
  );
  ...
  const disabledObjcet = {
    name: "",
    service_id: ServiceIdConstants.MAKEUP_ID,
  };
          ...
          <PageHeaderAlt className="border-bottom" overlap>
            <div className="container">
              <Flex
                ...
                alignItems="center"
              >
                <h2 className="mb-3">Edit MakeUp Tag </h2>
                <div className="mb-3">
                  <Button
                    className="mr-2"
                    onClick={() => history.push("makeupTags")}
                  >
                    Go Back
                  </Button>
                  <Button
